...
<script>
    ...
    xhr.open("GET", `${pageContext.request.contextPath}/type/getTypeById2?ptype=<%= Integer.parseInt(type_id) %>`, true);
                ...
                if (Array.isArray(type.planeList)) {
                    type.planeList.forEach(function (plane) {
                        ...
                        planeItem.innerHTML = "<b>飞机ID：</b> " + plane.plane_id + "<br>" +
                            '<b>名称：</b> <a href="${pageContext.request.contextPath}/plane/toplanePage?plane_id=' + plane.plane_id + '">' + plane.cname + '</a><br>' +
